export default function LoadingButton({ positionX = 'items-center', positionY = 'justify-center' }) {
    return (
        <div className={`min-h-screen flex flex-col ${positionX} ${positionY} py-12 sm:px-6 lg:px-8`}>
